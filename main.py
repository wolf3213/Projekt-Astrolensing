...
def plot_all_curves():
    ...
    folder = 'data2009/'#here is name of folder which contains data
    ...
    for filename in os.listdir(folder):
        ...
        if Predictor.predict_test(curve, Predictor.std_threshold, Predictor.count_threshold):#add here #
        #if Predictor.predict_test_v2(curve): #add here #
            params = f"{curve.some_value:.0}|{curve.time_mean:.1f}|{curve.time_std:.1f}|{curve.discarded_count}|{filename[:-4:]}" #add here #
...
if __name__ == "__main__":
    ...
    #filename = "data/blgXXX_X_i_114.dat"
    #filename="data/1.dat"
